...
graph TD
    ...
    %% Styling subgraphs by ID
    style DC1 fill:#FFFACD,stroke:#333,stroke-width:2px
    style DC2 fill:#FFFACD,stroke:#333,stroke-width:2px
    style DC3 fill:#FFFACD,stroke:#333,stroke-width:2px
    style SAN1 fill:#FF2A00,stroke:#333,stroke-width:2px
    style SAN2 fill:#FF2A00,stroke:#333,stroke-width:2px
    style SAN3 fill:#FF2A00,stroke:#333,stroke-width:2px
```
